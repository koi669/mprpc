...
namespace fixbug {
class GetFriendListsReauest;
class GetFriendListsReauestDefaultTypeInternal;
extern GetFriendListsReauestDefaultTypeInternal _GetFriendListsReauest_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::fixbug::GetFriendListsReauest* Arena::CreateMaybeMessage<::fixbug::GetFriendListsReauest>(Arena*);
...
class GetFriendListsReauest :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListsReauest) */ {
 public:
  GetFriendListsReauest();
  virtual ~GetFriendListsReauest();

  GetFriendListsReauest(const GetFriendListsReauest& from);
  GetFriendListsReauest(GetFriendListsReauest&& from) noexcept
    : GetFriendListsReauest() {
    *this = ::std::move(from);
  }

  inline GetFriendListsReauest& operator=(const GetFriendListsReauest& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListsReauest& operator=(GetFriendListsReauest&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriendListsReauest& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriendListsReauest* internal_default_instance() {
    return reinterpret_cast<const GetFriendListsReauest*>(
               &_GetFriendListsReauest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(GetFriendListsReauest& a, GetFriendListsReauest& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListsReauest* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline GetFriendListsReauest* New() const final {
    return CreateMaybeMessage<GetFriendListsReauest>(nullptr);
  }

  GetFriendListsReauest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriendListsReauest>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriendListsReauest& from);
  void MergeFrom(const GetFriendListsReauest& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListsReauest* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListsReauest";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListsReauest)
 private:
  class _Internal;
...
// uint32 userid = 1;
inline void GetFriendListsReauest::clear_userid() {
  userid_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListsReauest::_internal_userid() const {
  return userid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListsReauest::userid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsReauest.userid)
  return _internal_userid();
}
inline void GetFriendListsReauest::_internal_set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  userid_ = value;
}
inline void GetFriendListsReauest::set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListsReauest.userid)
}
