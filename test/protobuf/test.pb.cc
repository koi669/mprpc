...
class GetFriendListsReauestDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFriendListsReauest> _instance;
} _GetFriendListsReauest_default_instance_;
...
static void InitDefaultsscc_info_GetFriendListsReauest_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFriendListsReauest_default_instance_;
    new (ptr) ::fixbug::GetFriendListsReauest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFriendListsReauest::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetFriendListsReauest_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetFriendListsReauest_test_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsReauest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsReauest, userid_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 21, -1, sizeof(::fixbug::GetFriendListsReauest)},
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFriendListsReauest_default_instance_),
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "dListsReauest\032\036.fixbug.GetFriendListsRes"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_test_2eproto_sccs[6] = {
  &scc_info_GetFriendListsReauest_test_2eproto.base,
...
void GetFriendListsReauest::InitAsDefaultInstance() {
}
class GetFriendListsReauest::_Internal {
 public:
};

GetFriendListsReauest::GetFriendListsReauest()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.GetFriendListsReauest)
}
GetFriendListsReauest::GetFriendListsReauest(const GetFriendListsReauest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  userid_ = from.userid_;
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFriendListsReauest)
}

void GetFriendListsReauest::SharedCtor() {
  userid_ = 0u;
}

GetFriendListsReauest::~GetFriendListsReauest() {
  // @@protoc_insertion_point(destructor:fixbug.GetFriendListsReauest)
  SharedDtor();
}

void GetFriendListsReauest::SharedDtor() {
}

void GetFriendListsReauest::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFriendListsReauest& GetFriendListsReauest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendListsReauest_test_2eproto.base);
  return *internal_default_instance();
}


void GetFriendListsReauest::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFriendListsReauest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFriendListsReauest::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListsReauest::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFriendListsReauest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFriendListsReauest)
  return target;
}

size_t GetFriendListsReauest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListsReauest)
  size_t total_size = 0;
...
void GetFriendListsReauest::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFriendListsReauest)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendListsReauest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendListsReauest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFriendListsReauest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFriendListsReauest)
    MergeFrom(*source);
  }
}

void GetFriendListsReauest::MergeFrom(const GetFriendListsReauest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListsReauest)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFriendListsReauest::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFriendListsReauest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFriendListsReauest::CopyFrom(const GetFriendListsReauest& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFriendListsReauest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFriendListsReauest::IsInitialized() const {
  return true;
}

void GetFriendListsReauest::InternalSwap(GetFriendListsReauest* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(userid_, other->userid_);
}

::PROTOBUF_NAMESPACE_ID::Metadata GetFriendListsReauest::GetMetadata() const {
  return GetMetadataStatic();
}
...
void UserServiceRpc::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::GetFriendListsReauest*,
  ...
  switch(method->index()) {
    ...
    case 1:
      GetFriendLists(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendListsReauest*>(
                 request),
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetRequestPrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::GetFriendListsReauest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
void UserServiceRpc_Stub::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                              const ::fixbug::GetFriendListsReauest* request,
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendListsReauest* Arena::CreateMaybeMessage< ::fixbug::GetFriendListsReauest >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::GetFriendListsReauest >(arena);
}
