...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::ResultCode, errmag_),
  ~0u,  // no _has_bits_
...
ResultCode::ResultCode(const ResultCode& from)
  ...
  errmag_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_errmag().empty()) {
    errmag_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.errmag_);
  }
...
void ResultCode::SharedDtor() {
  errmag_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          auto str = _internal_mutable_errmag();
...
::PROTOBUF_NAMESPACE_ID::uint8* ResultCode::_InternalSerialize(
  ...
  // bytes errmag = 2;
  if (this->errmag().size() > 0) {
    target = stream->WriteBytesMaybeAliased(
        2, this->_internal_errmag(), target);
  }
...
void ResultCode::InternalSwap(ResultCode* other) {
  ...
  errmag_.Swap(&other->errmag_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
