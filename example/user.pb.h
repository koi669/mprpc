...
class ResultCode :
 ...
 public:
  ...
  enum : int {
    kErrmagFieldNumber = 2,
    kErrcodeFieldNumber = 1,
  };
  // bytes errmag = 2;
  void clear_errmag();
  const std::string& errmag() const;
  void set_errmag(const std::string& value);
  void set_errmag(std::string&& value);
  void set_errmag(const char* value);
  void set_errmag(const void* value, size_t size);
  std::string* mutable_errmag();
  std::string* release_errmag();
  void set_allocated_errmag(std::string* errmag);
  private:
  const std::string& _internal_errmag() const;
  void _internal_set_errmag(const std::string& value);
  std::string* _internal_mutable_errmag();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr errmag_;
...
// bytes errmag = 2;
inline void ResultCode::clear_errmag() {
  errmag_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& ResultCode::errmag() const {
  // @@protoc_insertion_point(field_get:fixbug.ResultCode.errmag)
  return _internal_errmag();
}
inline void ResultCode::set_errmag(const std::string& value) {
  _internal_set_errmag(value);
  // @@protoc_insertion_point(field_set:fixbug.ResultCode.errmag)
}
inline std::string* ResultCode::mutable_errmag() {
  // @@protoc_insertion_point(field_mutable:fixbug.ResultCode.errmag)
  return _internal_mutable_errmag();
}
inline const std::string& ResultCode::_internal_errmag() const {
  return errmag_.GetNoArena();
}
inline void ResultCode::_internal_set_errmag(const std::string& value) {
  
  errmag_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void ResultCode::set_errmag(std::string&& value) {
  
  errmag_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.ResultCode.errmag)
}
inline void ResultCode::set_errmag(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  errmag_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.ResultCode.errmag)
}
inline void ResultCode::set_errmag(const void* value, size_t size) {
  
  errmag_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.ResultCode.errmag)
}
inline std::string* ResultCode::_internal_mutable_errmag() {
  
  return errmag_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ResultCode::release_errmag() {
  // @@protoc_insertion_point(field_release:fixbug.ResultCode.errmag)
  
  return errmag_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ResultCode::set_allocated_errmag(std::string* errmag) {
  if (errmag != nullptr) {
    
  } else {
    
  }
  errmag_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), errmag);
  // @@protoc_insertion_point(field_set_allocated:fixbug.ResultCode.errmag)
}
